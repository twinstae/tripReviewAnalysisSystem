...
df1 = pd.read_csv(file1, encoding = 'utf-8', engine='python', index_col = 0)
df2 = pd.read_csv(file2, encoding = 'utf-8', engine='python', index_col = 0)
df3 = pd.merge(df, df2, how='outer')
df3 = pd.merge(df3, df1, how='outer')
df = df3
print(df)
